...
export const AdminDashboardPage: React.FC = () => {
  ...
  const metricCards = [
    ...
    { label: 'Job Applications', value: metrics.totalApplications, icon: FileCheck, link: '/admin/jobs', color: 'text-cyan-600', bg: 'bg-cyan-50' },
    { label: 'Scheduled Interviews', value: metrics.totalInterviews, icon: Calendar, link: '/admin/jobs', color: 'text-amber-600', bg: 'bg-amber-50' },
