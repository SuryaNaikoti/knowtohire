...
export const EmployerNotificationsPage: React.FC = () => {
  ...
  return (
    <EmployerShell title="Employer Notifications" currentPath="/employer/notifications">
      <div className="space-y-6 max-w-4xl mx-auto">
        ...
        {isLoading ? (
          <div className="py-16 flex flex-col items-center justify-center">
            ...
            <p className="text-xs text-kth-slate-500">Loading recruiter notifications...</p>
          </div>
        ) : notifications.length === 0 ? (
          <Card className="p-12 text-center">
            <Bell className="w-10 h-10 text-kth-slate-300 mx-auto mb-3" />
            <h4 className="font-bold text-base text-kth-slate-900 mb-1">No Recruiter Notifications</h4>
            <p className="text-xs text-kth-slate-500">
              You will be alerted when new candidate applications arrive, interview slots are confirmed, or status updates occur.
            </p>
          </Card>
        ) : (
