...
const TEMPLATE_CATEGORIES = [
  ...
  { value: 'Contract', label: 'Employment & Master Services Agreements' },
  { value: 'Legal', label: 'NDAs & IP Protection' },
  { value: 'Compliance', label: 'Corporate & ESG Compliance Checklists' },
  { value: 'Resume', label: 'Standard ATS Rubrics & Job Profiles' },
];

export const EmployerTemplatesPage: React.FC = () => {
  ...
  return (
    <EmployerShell title="Enterprise Templates & Contracts" currentPath="/employer/templates">
      <div className="space-y-6 max-w-7xl mx-auto text-left font-sans">
          ...
          <div>
            <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-emerald-50 border border-emerald-200/80 mb-2 shadow-2xs">
              ...
              <span className="text-[10px] font-bold text-emerald-800 uppercase tracking-wider">
                Corporate Document Kits
              </span>
            </div>
            <h1 className="font-display text-2xl sm:text-3xl font-extrabold text-kth-slate-900 leading-tight">
              Templates & Legal Frameworks
            </h1>
            <p className="text-xs sm:text-sm text-kth-slate-600 mt-1 max-w-3xl leading-relaxed">
              Standardized MSAs, employment agreements, candidate assessment rubrics, and statutory compliance audit checklists for enterprise teams.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white p-3.5 sm:p-4 rounded-2xl border border-kth-slate-200 shadow-xs flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
          <div className="flex-1">
            <Input
              placeholder="Search contracts, NDAs, assessment rubrics..."
              value={searchTerm}
