...
const RESOURCE_CATEGORIES = [
  ...
  { value: 'Technology', label: 'Technology & Cloud Architecture' },
...
export const CandidateKnowledgePage: React.FC = () => {
  ...
  return (
    <CandidateShell title="Knowledge Hub" currentPath="/candidate/knowledge">
      <div className="space-y-6 max-w-6xl mx-auto text-left font-sans">
        ...
        <div className="bg-white p-6 md:p-8 rounded-2xl border border-kth-slate-200 shadow-xs flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            ...
            <p className="text-xs sm:text-sm text-kth-slate-600 mt-1 max-w-2xl leading-relaxed">
              Explore regulatory handbooks, research papers, system architecture blueprints, and study materials authored by specialists across India.
            </p>
          </div>
        ...
        <div className="bg-white p-3.5 sm:p-4 rounded-2xl border border-kth-slate-200 shadow-xs flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
          <div className="flex-1">
            <Input
              placeholder="Search e-books, research guides, technical topics..."
              value={searchTerm}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {resources.map((res) => (
              <ResourceCard
                ...
                author={res.author || 'KnowToHire Research Team'}
                format={res.format}
        ...
        <Dialog
          ...
          title="Request Custom Study Material / Guide"
          maxWidth="lg"
        >
          <form onSubmit={handleRequestSubmit} className="space-y-4 text-left font-sans pt-1">
            <p className="text-xs text-kth-slate-600 leading-relaxed">
              Need a specialized guide or research dossier not listed in our catalog? Our editorial team will review your request and publish it.
            </p>
            ...
            <div className="space-y-1.5">
              ...
              <Input
                placeholder="e.g. System Design Patterns & Microservices Architecture Guide"
                value={reqTitle}
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                rows={4}
                placeholder="Describe the key topics, specific frameworks to address, and intended use cases..."
            ...
            <div className="space-y-1.5">
              ...
              <Input
                placeholder="Any reference links, authors, or target deadlines..."
                value={reqAdditional}
