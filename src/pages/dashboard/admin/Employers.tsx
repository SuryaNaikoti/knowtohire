                      ...
                      {filteredCompanies.map((comp) => {
                        ...
                        return (
                          <tr
                            ...
                            className="hover:bg-slate-50/90 transition-colors duration-150 cursor-pointer"
                          >
                            <td className="py-4 px-5">
                              <div className="flex items-center gap-3">
                                ...
                                <div className="min-w-0">
                                  <p className="font-bold text-slate-900 text-sm leading-snug truncate hover:text-emerald-600 transition-colors">{comp.name}</p>
