...
export interface CandidateOnboardingProgressProps {
  currentStep: number;
...
const STEPS = [
  { id: 1, title: 'Basic Information', desc: 'Name, headline, location' },
  { id: 2, title: 'About You', desc: 'Bio & domain focus' },
  { id: 3, title: 'Key Skills', desc: 'Min. 3 skill tags' },
  { id: 4, title: 'Work Experience', desc: 'Seniority & past roles' },
  { id: 5, title: 'Education', desc: 'Degree & institution' },
  { id: 6, title: 'Certifications', desc: 'GRI, ISO, ESG credentials' },
  { id: 7, title: 'Career Preferences', desc: 'Target roles & work mode' },
  { id: 8, title: 'Salary Expectations', desc: 'INR (₹) target range' },
  { id: 9, title: 'Resume Upload', desc: 'PDF / DOCX document' },
  { id: 10, title: 'Review & Complete', desc: 'Final review & submit' },
];

export const CandidateOnboardingProgress: React.FC<CandidateOnboardingProgressProps> = ({
  currentStep,
  highestStepReached,
  onStepClick,
}) => {
  return (
    <nav aria-label="Candidate Onboarding Steps" className="space-y-1.5">
      {STEPS.map((step) => {
