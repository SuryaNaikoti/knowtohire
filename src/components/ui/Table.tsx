...
export const TableContainer: React.FC<React.HTMLAttributes<HTMLDivElement>> = ({ className, children, ...props }) => (
  <div className={cn("w-full overflow-x-auto border border-kth-slate-200 rounded-lg bg-white shadow-xs", className)} {...props}>
    {children}
  </div>
);
...
export const TableRow: React.FC<React.HTMLAttributes<HTMLTableRowElement>> = ({ className, children, ...props }) => (
  <tr className={cn("h-[44px] hover:bg-kth-slate-50 transition-colors duration-150", className)} {...props}>
    {children}
  </tr>
);

export const TableHead: React.FC<React.ThHTMLAttributes<HTMLTableCellElement>> = ({ className, children, ...props }) => (
  <th className={cn("px-4 py-3 font-semibold text-[11px] uppercase tracking-wider text-kth-slate-600 select-none", className)} {...props}>
    {children}
  </th>
);

export const TableCell: React.FC<React.TdHTMLAttributes<HTMLTableCellElement>> = ({ className, children, ...props }) => (
  <td className={cn("px-4 py-3 text-kth-slate-800 align-middle text-sm", className)} {...props}>
    {children}
  </td>
);
