...
export const DashboardLayout: React.FC = () => {
  ...
  const getSidebarItems = (userRole: 'candidate' | 'employer' | 'admin' | 'super_admin') => {
    ...
    const candidateItems = [
      ...
      { name: 'Work & Education', path: ROUTES.DASHBOARD.CANDIDATE.EXPERIENCE, icon: 'M8 7v8a2 2 0 002 2h6M8 7V5a2 2 0 012-2h4.586a1 1 0 01.707.293l4.414 4.414a1 1 0 01.293.707V15a2 2 0 01-2 2h-2M8 7H6a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2v-2' },
      ...
      { name: 'Applied Jobs', path: `${ROUTES.COMING_SOON}?feature=Jobs`, icon: 'M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z' },
      { name: 'Templates Library', path: `${ROUTES.COMING_SOON}?feature=Templates`, icon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4' },
    ...
    const employerItems = [
      ...
      { name: 'Billing & Subscriptions', path: `${ROUTES.COMING_SOON}?feature=Payments`, icon: 'M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z' },
    ];
