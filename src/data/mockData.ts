...
export const MOCK_JOBS: Job[] = [
  ...
  },
  {
    ...
    skills: ['React & TypeScript', 'Node.js & API Architecture', 'Database Systems & SQL', 'Cloud Infrastructure (AWS/GCP)'],
    matchScore: 88,
    postedDate: '3 days ago',
    department: 'Software Engineering',
    description: 'Join our agile product team to build responsive web applications, design REST/GraphQL APIs, and manage relational database schemas.',
    responsibilities: [
